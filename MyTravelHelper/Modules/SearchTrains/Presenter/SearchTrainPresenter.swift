...
class SearchTrainPresenter:ViewToPresenterProtocol {
    ...
    func fetchTrainsFromSource(sourceCode:String,destinationCode:String){
        interactor?.fetchTrainsFromSource(sourceCode: sourceCode, destinationCode: destinationCode)
    }
    ...
    func showInvalidSourceDestinationAlert(){
        interactor?.showInvalidSourceOrDestinationAlert()
    }
